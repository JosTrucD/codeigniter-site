          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <div class="shortcuts">
                ...
                <a href="<?php echo base_url() ?>nguoi-dung" class="shortcut">
                ...
                <a href="<?php echo base_url() ?>slider" class="shortcut">
                  <i class="shortcut-icon icon-picture"></i>
                  <span class="shortcut-label">Sliders</span> 
                </a>
                <a href="javascript:;" class="shortcut">
                  <i class="shortcut-icon icon-cogs"></i>
                  <span class="shortcut-label">System</span>
                </a>
              </div>
              <!-- /shortcuts --> 
            </div>
